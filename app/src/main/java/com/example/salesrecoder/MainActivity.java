...
public class MainActivity extends AppCompatActivity {
    ...
    private RadioGroup varientRadioGroup;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        varientRadioGroup=findViewById(R.id.varientColor);
        catagorySpinner.setSelection(1);
        ...
        submit_data_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int radioButtonId=varientRadioGroup.getCheckedRadioButtonId();
                selectedButton=(RadioButton)findViewById(radioButtonId);
                String varient=selectedButton.getText().toString();
                if (TextUtils.isEmpty(varient)){
                    Toast.makeText(MainActivity.this,"Please Select One Varient.",Toast.LENGTH_SHORT).show();

                }
                if (catagorySpinner.getSelectedItemPosition()==0){

                    Toast.makeText(MainActivity.this,"Please Select One Catagory.",Toast.LENGTH_SHORT).show();
